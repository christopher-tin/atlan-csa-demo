...
def main():
    ...
    for s3_object in aws_s3_objects:
        ...
        create_s3_object(client, connection_qualified_name, bucket_qualified_name, s3_object)
        ...
        try:
            ...
            create_lineage_postgres_to_s3(client, connection_qualified_name, postgres_table, atlan_s3_obj)
            create_lineage_s3_to_snowflake(client, connection_qualified_name, atlan_s3_obj, snowflake_table)
